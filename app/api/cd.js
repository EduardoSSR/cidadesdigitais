...
//---------------Callbacks de Processo da Cidade Digital---------------//
    ...
    api.listaCdProcessso = function (req, res){
        ...
        cdDAO.listarProcesso(cod_ibge, function (erro, resultado){
            if(erro){
                console.log(erro);
                res.sendStatus(500);
            }else{
...
//---------------Callbacks de Acompanhamento da Cidade Digital---------------//
    ...
    api.listaCdAcompanhamento = function (req, res){
        ...
        cdDAO.listarAcompanhamento(cod_ibge, function (erro, resultado){
            if(erro){
                console.log(erro);
                res.sendStatus(500);
            }else{
...
//---------------Callbacks de Ponto da Cidade Digital---------------//
    ...
    api.listaCdPonto = function (req, res){
        ...
        cdDAO.listarPonto(cod_ibge, function (erro, resultado){
            if(erro){
                console.log(erro);
                res.sendStatus(500);
            }else{
...
//---------------Callbacks de Previsão de Empenho da Cidade Digital---------------//
    
    //Lista todas as Previsao de Empenho da Cidade Digital.
    api.listaCdPrevisaoEmpenho = function(req, res){
        var cod_lote = req.params.cod_lote;
        
        var connection = app.infra.connectionFactory();
        var cdDAO = new app.infra.CdDAO(connection);
        
        cdDAO.listarCdPrevisaoEmpenho(cod_lote, function (erro, resultado){
            if(erro){
                console.log(erro);
                res.sendStatus(500);
            }else{
...
//---------------Callbacks de Empenho da Cidade Digital---------------//
    
    //Lista todos os Empenho da Cidade Digital.
    api.listaCdEmpenho = function(req, res){
        var cod_lote = req.params.cod_lote;
        
        var connection = app.infra.connectionFactory();
        var cdDAO = new app.infra.CdDAO(connection);
        
        cdDAO.listarCdEmpenho(cod_lote, function (erro, resultado){
            if(erro){
                console.log(erro);
                res.sendStatus(500);
            }else{
...
//---------------Callbacks de Fatura da Cidade Digital---------------//
    
    //Lista todas as Faturas da Cidade Digital.
    api.listaCdFatura = function(req, res){
        var cod_ibge = req.params.cod_ibge;
        
        var connection = app.infra.connectionFactory();
        var cdDAO = new app.infra.CdDAO(connection);
        
        cdDAO.listarCdFatura(cod_ibge, function (erro, resultado){
            if(erro){
                console.log(erro);
                res.sendStatus(500);
            }else{
