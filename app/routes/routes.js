...
//*************** Rotas em Cidade Digital (cd) ***************//
    ...
    app.route('/read/processo/:cod_ibge')
    ...
    app.route('/read/acompanhamento/:cod_ibge')
    ...
    //---------Rotas de Previsão de Empenho da Cidade Digital---------//
    app.route('/read/previsaoEmpenho/cd/:cod_lote')
        .get(cd.listaCdPrevisaoEmpenho);
    
    //---------Rotas de Empenho da Cidade Digital---------//
    app.route('/read/empenho/cd/:cod_lote')
        .get(cd.listaCdEmpenho);
    
    //---------Rotas de Fatura da Cidade Digital---------//
    app.route('/read/fatura/cd/:cod_ibge')
        .get(cd.listaCdFatura);
    
    

//*************** Rotas em Contato ***************//
    //---------Rotas de Contato---------//
    app.route('/read/contato/cd/:cod_ibge')
        .get(contato.listaContatoCd);
    
    app.route('/read/contato/entidade/:cnpj')
        .get(contato.listaContatoCnpj);
...
//*************** Rotas em Empenho ***************//
    ...
    app.route('/read/empenhoItens/:cod_empenho/:cod_lote')
...
//*************** Rotas em Fatura ***************//
    ...
    app.route('/read/fatura/:num_nf/:cod_ibge')
    ...
    app.route('/read/faturaItens/:num_nf/:cod_ibge')
    ...
    app.route('/read/faturaItens/:fatura_num_nf/:cod_empenho/:cod_item/:cod_tipo_item/:cod_ibge')
...
//*************** Rotas em Municipios ***************//
    ...
    app.route('/read/municipios/estado/:uf')
        .get(municipio.listaMunicipioPorEstado);
