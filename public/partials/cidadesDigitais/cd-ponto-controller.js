angular.module('cidadesdigitais').controller('CdPontoController', function ($scope, $http, $stateParams, growl, InjecaoInfo) {
    ...
    function getPontos() {
        InjecaoInfo.getVisuPonto(codIbge)
    ...
    $scope.enviarPontoAdd = function () {
        ...
        if (existe == false) {
            ...
            InjecaoInfo.postPonto(pontoCds)
                .success(function () {
