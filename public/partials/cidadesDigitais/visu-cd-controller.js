angular.module('cidadesdigitais').controller('visuCidadedigitaisController', function ($scope, InjecaoInfo, growl, $window) {
   ...
   /*============== Funcao para exibir as mensagens referentes ao banco =================*/
    ...
    .error(function(error){
        var msg = "<strong>" + error + "!</strong><p>Ocorreu um erro ao carregar os dados do servidor. Por favor tente novamente mais tarde.</p>";
