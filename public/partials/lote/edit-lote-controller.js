angular.module('cidadesdigitais').controller('editLotesController', function ($scope, $stateParams, $filter, InjecaoInfo, growl, $window) {
    ...
    function carregaController() {
        if (permitido) {
            ...
            $scope.loteId = $stateParams.loteId;
            ...
            function carregarLote() {
                if ($stateParams.loteId) {
                    InjecaoInfo.getLoteById($stateParams.loteId)
            ...
            function getItens() {
                InjecaoInfo.getLoteItens($stateParams.loteId)
