angular.module('cidadesdigitais').controller('editPrevisaoEmpenhoController', function ($scope, $http, $stateParams, $filter, InjecaoInfo, growl, $window) {
    ...
    function carregaController() {
        if (permitido) {
            ...
            $scope.getPrevEmpById = function () {
                InjecaoInfo.getPrevEmpById($stateParams.previsaoEmpenhoID)
            ...
            $scope.getLotes = function () {
                InjecaoInfo.getPrevisaoEmpenhoItens($scope.prevEmpenhos.lote_cod_lote ,$stateParams.previsaoEmpenhoID)
            ...
            $scope.updatePrevEmpItens = function (visuItensEmpenhos) {
                ...
                for (var i = 0; i < $scope.visuItensEmpenhos.length; i++) {
                    ...
                    putArrayItensEmpenho[i] = {
                        previsao_empenho_cod_previsao_empenho: $stateParams.previsaoEmpenhoID,
                        ...
                        valor: $scope.visuItensEmpenhos[i].valor,
