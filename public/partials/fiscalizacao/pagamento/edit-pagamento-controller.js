angular.module('cidadesdigitais').controller('editPagamentoController', function ($scope, $stateParams, $filter, InjecaoInfo, growl, $window) {
    ...
    $scope.getPagamentoById = function(){
        if($stateParams.pagamentoId){
            InjecaoInfo.getPagamentoById($stateParams.pagamentoId)
    ...
    $scope.getFatura = function(){
        InjecaoInfo.getFaturaByOtbId($stateParams.pagamentoId)
        .success(function(fatura){
    ...
    $scope.getItens = function(){
        InjecaoInfo.getItensPagamento($stateParams.pagamentoId)
    ...
    $scope.addFaturaPag = function(pagamento) {
        ...
        if(!existe){
            $scope.fatOtb = {
                otb_cod_otb: $stateParams.pagamentoId,
    ...
    $scope.editDtPag = function(dtPag) {
        $scope.pagEdit = {
            cod_otb: $stateParams.pagamentoId,
