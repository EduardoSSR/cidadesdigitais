angular.module('cidadesdigitais').controller('visuEmpenhoController', function ($scope, $http, $stateParams, InjecaoInfo, growl, $window) {
/*============== Funcao para exibir as mensagens referentes ao banco =================*/
    ...
    if (permitido) {
     ...
     if ($stateParams.empenhoId) {
         $http.get({
             empenhoId: $stateParams.empenhoId
         }, function () {
