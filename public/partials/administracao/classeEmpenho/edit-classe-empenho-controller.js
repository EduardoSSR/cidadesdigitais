angular.module('cidadesdigitais').controller('editClasseEmpController', function ($http ,$scope, $stateParams, $filter, InjecaoInfo, growl, $window) {
    ...
    if (permitido) {
    InjecaoInfo.getClasseById($stateParams.empenhoId)
