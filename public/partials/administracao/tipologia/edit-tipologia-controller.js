angular.module('cidadesdigitais').controller('editTipologiaController', function ($scope, $stateParams, $filter, InjecaoInfo, growl, $window) {
    ...
    InjecaoInfo.getTipologiaId($stateParams.tipologiaID)
