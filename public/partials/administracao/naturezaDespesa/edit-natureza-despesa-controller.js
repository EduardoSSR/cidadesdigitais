angular.module('cidadesdigitais').controller('editNaturezaDespController', function ($scope, growl, $filter, $stateParams, InjecaoInfo, $window) {
    ...
    if (permitido) {
    InjecaoInfo.getNaturezaDespesaId($stateParams.naturezaDepId)
