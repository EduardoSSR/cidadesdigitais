angular.module('cidadesdigitais').controller('editAssuntoController', function ($scope, $routeParams, growl, InjecaoInfo, $location, $window) {
    ...
    function carregaController() {
        if (permitido) {
    var idAssunto = $routeParams.idAssunto;
